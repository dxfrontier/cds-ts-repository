...
/**
 * This ExtractSingular type is being used in `BaseRepository & BaseRepositoryDraft` to take the singular object `Entity` instead of the Array<object> generated by the `cds-typer`
 */
